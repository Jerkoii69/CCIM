        ...
        <table> 
            <h2>
             <tr>
                   ...
                   <td><input type="text" name="tungolFirstName" id="tungolFirstName" placeholder="First Name"  required> <br>
                   </td>

                   <td><input type="text" name="tungolLastName" id="tungolLastName" placeholder="First Name" required><br>
                   </td>
             </tr>
